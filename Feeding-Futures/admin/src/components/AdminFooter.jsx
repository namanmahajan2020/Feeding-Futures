  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="admin-fade-up text-center text-sm">
          &copy; {currentYear} Feeding Futures - All rights reserved.
        </div>

        <div className="flex space-x-4 gap-3">
          <a href="https://www.facebook.com/">
            <img className="admin-interactive w-7" src="img/facebook.png" alt="Facebook" />
          </a>
          <a href="https://www.instagram.com/">
            <img className="admin-interactive w-7" src="img/instagram.png" alt="Instagram" />
          </a>
          <a href="https://www.youtube.com/">
            <img className="admin-interactive w-7" src="img/youtube.png" alt="Youtube" />
          </a>
        </div>
      </div>
    </footer>
