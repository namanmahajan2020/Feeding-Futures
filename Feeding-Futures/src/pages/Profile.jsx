    ...
    <div className="min-h-screen bg-gray-50">
      <header className="flex justify-between items-center p-4 bg-white shadow-md fixed top-0 left-0 w-full z-10">
        ...
        <nav className="hidden md:flex space-x-6 text-gray-700 font-medium">
          ...
          <Link to="/profile" className="text-green-600 border-b-2 border-green-600">Profile</Link>
        </nav>
      </header>

      <div className="max-w-3xl mx-auto mt-28 bg-white rounded-2xl shadow-md p-6">
        <h2 className="text-3xl font-semibold underline decoration-green-500 mb-6 flex items-center">
          <img src="/user.png" alt="user" className="w-10 h-10 mr-3" />
          Profile
        </h2>
